...
(function(global, factory) {
	...
	var Gauge = (function() {
	  ...
	  var defaultOptions = {
		...
		valueTextClassUnity:"value-text-unity", //
		dialClass: "dial",
		gaugeClass: "gauge",
		showValue: true,
		gaugeColor: null,
	  ...
	  return function Gauge(elem, opts) {
		...
		var gaugeContainer = elem,
			...
			valueTextClassUnity = opts.valueTextClassUnity, //
		...
		function initializeGauge(elem) {
		  ...
		  gaugeValueElemUnity = svg("text", {
			x: 60,
			y: 60,
			fill: "#999",
			"class": valueTextClassUnity,
			"font-size": "50%",
			"font-family": "sans-serif",
			"font-weight": "normal",
		  ...
		  var gaugeElement = svg("svg", {"viewBox": viewBox || "0 0 100 100", "class": gaugeClass}, [
			...
			svg("g", { "class": "text-container" }, [gaugeValueElem, gaugeValueElemUnity]),
			gaugeValuePath
		  ]);
		  elem.appendChild(gaugeElement);
		}
  
		function updateGauge(theValue,theUnit ,frame) {
		  ...
		  if(displayValue) {
			...
			gaugeValueElemUnity.textContent = unity.call(opts, theUnit);
		  }
